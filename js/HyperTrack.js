...
class HyperTrackAPI {
    ...
    registerDeviceUpdatesListeners(component: Object,
        onError: (error: ?Error) => void,
        ...
        if (onError) component.onErrorDeviceUpdatesSubscription = EventEmitter.addListener('onErrorDeviceUpdates', onError);
        if (onLocationUpdate) component.onLocationUpdateSubscription = EventEmitter.addListener('onLocationUpdateReceived', onLocationUpdate);
        if (onBatteryStateUpdate) component.onBatteryStateUpdateSubscription = EventEmitter.addListener('onBatteryStateUpdateReceived', onBatteryStateUpdate);
        if (onStatusUpdate) component.onStatusUpdateSubscription = EventEmitter.addListener('onStatusUpdateReceived', onStatusUpdate);
        if (onTripUpdate) component.onTripUpdateSubscription = EventEmitter.addListener('onTripUpdateReceived', onTripUpdate);
        if (onCompletedDeviceUpdate) component.onCompletedDeviceUpdateSubscription = EventEmitter.addListener('onCompletedDeviceUpdates', onCompletedDeviceUpdate);
     ...
     */
    unregisterTrackingListeners(component: Object) {
        component.onErrorDeviceUpdatesSubscription && component.onErrorDeviceUpdatesSubscription.remove();
        component.onLocationUpdateSubscription && component.onLocationUpdateSubscription.remove();
        component.onBatteryStateUpdateSubscription && component.onBatteryStateUpdateSubscription.remove();
        component.onStatusUpdateSubscription && component.onStatusUpdateSubscription.remove();
        component.onTripUpdateSubscription && component.onTripUpdateSubscription.remove();
        component.onCompletedDeviceUpdateSubscription && component.onCompletedDeviceUpdateSubscription.remove();
    }
}
module.exports = {
    /**
